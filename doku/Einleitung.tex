...
Die Kinect 2 von Microsoft ist der Nachfolger der Ursprüglichen Kinect, die für die xBox 360 und wurde vorallem für Spiele entwickelt wurde.
In diesem Gebiet fand sie jedoch wenig Markterfolg. Darum wurde die Kinect für xBox nach der Kinect 2 eingestellt.
Seit dem findet die Kinect vor allem in Applicationen der Kameravison Anwendungen. Beispielsweise ist hier das Ganzkörpertracking für VR-Anwendungen zu nennen.
Durch diese Entwicklung hat sich Microsoft dazu entschieden, die Kinect Azure für Unternehmen zu entwickeln und als Entwicklungsumgebung zu vermarkten.\\
Durch die 3 Kameras, wovon eine Infrarot- und eine Tiefenkamera verbaut sind, und den on-Board Prozessor kann die Kinect in Projekten viel Arbeit
abnehmen, da sie bereits viele Daten auswerten und verarbeiten kann. So gibt die Kinect dem Anwender bis zu 6 Ganzkörper Skelette mit einzelnen "Gelenken"
die danach weiter ausgewertet werden können. Außerdem ist einen Gesten und Mimikerkennung bereits mit verbaut.\\
...
Hierfür werden von Google mehrere vortrainierte Modelle über den Detection Model Zoo bereitgestellt, die innerhalb von wenigen Stunden und mit relativ kleinen Datenmengen auf einen neuen Datensatz gangepasst werden können.

\newpage
\section{Anforderungen}
Der Krahn soll sich über Wlan mit einem Server, der lokal auf einem Rechner im Labor läuft, verbinden und dieser soll die Daten aus der Erkennung von
