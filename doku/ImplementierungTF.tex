...
\subsubsection{GUI}
Die GUI wurde sehr simpel gehalten um möglichst wenig CPU-Time zu brauchen.
\begin{figure}[H]
    \centering
...
Die Anwendung wird über aufrufen von \textit{CraneControl.py} mit Python gestartet. 
