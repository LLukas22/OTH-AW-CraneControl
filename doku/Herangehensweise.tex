...
die Geste für Bewgung mit einer Richtungsangabe über das Skelett versehen. Diese werden dann an den Server übergeben, das dieser diese dem Krahn auf
...
Danach wurdeb mit der Tensorflow-Object-Detection-API verschiedene CNN-Modelle trainiert, damit sie die Gesten in einem Webcam-Stream erkennen. Die fertig Python Application lädt eines der Modelle, erkennt die Gesten , zeichnet Rechtecke um die erkannten Gesten und ermittelt die dazugehörige Krahnbewegung.
