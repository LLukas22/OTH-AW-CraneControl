...
\begin{figure}[H]
    \centering
    \subfigure[IR]{\includegraphics[width=0.4\textwidth]{Kinect IR picture.png}}
    \subfigure[depth]{\includegraphics[width=0.4\textwidth]{Kinect depth picture.jpg}}
...
Ein Beispiel ist auf Folgendem Link Aufgeführt.\cite{KinectBackgroundRemoval}\\
\subsubsection{Facedetection}
Weiterhin ist in der Kinect bereits eine vielzahl an Tools zu Gesichtserkennung integriert.
\cite{KinectFaceTracking}
\begin{figure}[H]
    \centering
...
Wie schon im Vorherigen Kapitel erwähnt, unterstützt die Kinect die Erkennung von Handgesten. Vorgefertigt sind die Gesten Lasso, Offen und Geschlossen.
