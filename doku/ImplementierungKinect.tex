...
Befehlen. Damit wird der Speicher im Server aktualisiert, von dem der Server ließt um dem Krahn Daten zu senden.\\
Die Erkennung der Gesten für den Regler und die Betriebsmodi ist durch die Kinect bereits zu einem großem Teil implementiert. Man muss sich nur
...
Die Richtungsgesten gestalten sich etwas komplizierter, da zur Geste Lasso auch noch eine Richtung benötigt wird. Dazu kann das Skelett, welches die
...
die Lasso Geste erkannt wurde an und vergleicht den Unterschied der x und y Koordinaten von Handmittelpunkt und Fingerspitzen.
\\\
...
Zahnradsymbol ein Optionspannel ausgeklappt werden. Dort kann der Port, auf dem sich der Krahn verbinden soll angegeben werden(Standard ist 54000),
...
Außerdem kann die Beschleunigungs des Krahns verändert werden. Über Knöpfe kann der Server pausiert werden, so das keine Pakete mehr gesendet werden,
