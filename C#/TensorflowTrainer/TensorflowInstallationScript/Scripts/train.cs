...
{
	public class Train : BaseScript
	{
		public const int TrainSteps = 50000;
		public const float GpuMemoryFraction = 0.333f;
		public Train(DirectoryPaths directoryPaths)
		{
			ScriptName = "train.py";
...
CONFIGPATH = "+CleanUpPath(Path.Combine(directoryPaths.Training, "customPipeline.config"))+@"
MODELPATH = "+CleanUpPath(directoryPaths.Training) +@"
TRAINSTEPS = "+ TrainSteps + @"
GPULIMIT = "+ GpuMemoryFraction.ToString().Replace(",",".") + @"
...
def main(unused_argv):
  ...
  opts = tf.GPUOptions(per_process_gpu_memory_fraction = GPULIMIT)
  config.gpu_options = opts
