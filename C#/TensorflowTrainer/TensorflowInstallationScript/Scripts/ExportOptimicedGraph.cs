...
//"""
	...
	public class ExportOptimicedGraph : BaseScript
	{
		public ExportOptimicedGraph(DirectoryPaths directoryPaths)
		{
			ScriptName = "exportLightGraph.py";

			Script = @"

import sys
SLIM_PATH =" + $" '{CleanUpPath(Path.Combine(directoryPaths.Research, @"slim"))}'" + @"
